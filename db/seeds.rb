...
Announcement.create([
  {
    title: "Welcome, Guest!",
    content: "<p>Thanks for checking out Everyday Heroes! Feel free to browse the site and interact with it as a user would. You can read about tasks/challenges and even mark them as complete. Get a feel for how the program goes.</p><p>We hope you'll decide that Everyday Heroes would be a valuable addition to your life. We'd love to have you as a member of our community. If so, create a real account, and sign up!</p>",
    url: nil,
    embed_url: nil,
  }
])

guest = User.where({first_name: "GUEST"}).first
